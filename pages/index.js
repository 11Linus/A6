...
* 
*  Name: Kin Lok ChanStudent ID: 119293215 Date: 12/3/2022
*
*  Vercel App (Deployed) Link: https://a6-9rdwpze52-11linus.vercel.app
*
********************************************************************************/ 
...
export default function Home(){
  return(
    ...
    <Row>
      ...
      <Col md={6}>
      <p>
      The Metropolitan Museum of Art of New York City, colloquially &quot the Met &quot , is the largest art museum in the Americas. 
      Its permanent collection contains over two million works, divided among 17 curatorial departments. 
      The main building at 1000 Fifth Avenue, along the Museum Mile on the eastern edge of Central Park on Manhattan &apos s Upper East Side, is by area one of the world &apos s largest art museums. 
      ...
      The museum &apos s permanent collection consists of works of art from classical antiquity and ancient Egypt, paintings, and sculptures from nearly all the European masters, and an extensive collection of American and modern art. 
      ...
      <Col md={6}>
        <p>
        The Fifth Avenue building opened on March 30, 1880. In 2021, despite the COVID-19 pandemic in New York City, the museum attracted 1,958,000 visitors, ranking fourth on the list of most-visited art museums in the world.[5]
        </p>
